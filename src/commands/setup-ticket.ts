...
import { saveTicketConfig, ticketPanelComponents } from '../utils/ticketManager';

export const data = new SlashCommandBuilder()
  .setName('setup-ticket')
  .setDescription('Configura il pannello di supporto C.S.S.D.')
