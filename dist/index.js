 ...
 * ============================================================
 */
client.on('messageDelete', (message) => (0, serverLogger_1.logMessageDelete)(client, message).catch((error) => {
...
client.on('guildMemberRemove', (member) => (0, serverLogger_1.logMemberLeave)(client, member).catch((error) => {
    console.error('[SERVER LOG] Errore durante il log dell\'uscita dal server:', error);
}));
client.on('guildBanAdd', (ban) => (0, serverLogger_1.logBan)(client, ban.guild, ban.user, true).catch((error) => {
    console.error('[SERVER LOG] Errore durante il log del ban:', error);
}));
client.on('guildBanRemove', (ban) => (0, serverLogger_1.logBan)(client, ban.guild, ban.user, false).catch((error) => {
    console.error('[SERVER LOG] Errore durante il log della rimozione del ban:', error);
}));
client.on('guildMemberUpdate', (oldMember, newMember) => (0, serverLogger_1.logMemberUpdate)(client, oldMember, newMember).catch((error) => {
    console.error('[SERVER LOG] Errore durante il log della modifica del membro:', error);
}));
client.on('roleCreate', (role) => (0, serverLogger_1.logRoleCreate)(client, role).catch((error) => {
    console.error('[SERVER LOG] Errore durante il log della creazione del ruolo:', error);
}));
client.on('roleDelete', (role) => (0, serverLogger_1.logRoleDelete)(client, role).catch((error) => {
    console.error('[SERVER LOG] Errore durante il log dell\'eliminazione del ruolo:', error);
}));
client.on('roleUpdate', (oldRole, newRole) => (0, serverLogger_1.logRoleUpdate)(client, oldRole, newRole).catch((error) => {
...
client.on('channelCreate', (channel) => {
    ...
    (0, serverLogger_1.logChannelCreate)(client, channel).catch((error) => {
...
client.on('channelDelete', (channel) => {
    ...
    (0, serverLogger_1.logChannelDelete)(client, channel).catch((error) => {
...
client.on('channelUpdate', (oldChannel, newChannel) => {
    ...
    (0, serverLogger_1.logChannelUpdate)(client, oldChannel, newChannel).catch((error) => {
